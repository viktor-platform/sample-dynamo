...
class ResidentialBlockParametrization(Parametrization):
	...
	step_1.number_of_houses = NumberField("Number of houses", max=8.0, min=1.0, variant='slider', step=1.0, default=1.0)

	step_2 = Step("Model parameters", views="geometry_and_data_view")

	step_2.number_of_houses = NumberField("Number of houses", max=8.0, min=1.0, variant='slider', step=1.0, default=1.0)
