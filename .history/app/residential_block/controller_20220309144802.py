	...
	def get_map_view(self, params: Munch, **kwargs) -> MapResult:
		...
		if params.tab1.section2.point:
			...
			for house in range(0,n_houses,1):
				...
				polygon_coords = []
				print(len(map_point_list))
				for n in range(1,len(map_point_list)+1):
				...
				if house!=0:
					features.append(map_point_list[-1])
					features.append(map_point_list[-2])
					features.append(map_point_list[-3])
					features.append(map_point_list[-4])
