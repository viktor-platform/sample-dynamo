...
class ResidentialBlockController(ViktorController):
	...
	def get_map_view(self, params: Munch, **kwargs) -> MapResult:
		...
		if params.tab1.section2.line:
			...
			Phi = (coords[3]-coords[1])/(coords[2]-coords[0])
			print(Phi)
			...
			transformed_y_wgs, transformed_x_wgs = RDWGSConverter.from_rd_to_wgs((x, y))
			features.append(MapPoint(transformed_y_wgs, transformed_x_wgs))
