...
class ResidentialBlockParametrization(Parametrization):
    ...
    \n Choose the parameters for the dynamo visualization of the residential block. Then, press the update button to create the visualization. This could take a few seconds""")
