...
def run_dynamo(params):
    """ This method collects, updates and then runs the dynamo model. Two output files are generated from the
    dynamo model, the geometry and a numerical output. The geometry is always generated, the numerical output is
    optional and dependant and the dynamo model."""
