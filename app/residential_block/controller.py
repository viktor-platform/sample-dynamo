...
from viktor import UserException, File
...
from viktor.external.dynamo import DynamoFile, get_dynamo_result
...
class ResidentialBlockController(ViktorController):
    ...
    def run_dynamo(self, params):
        ...
        files = [('dynamo_model_sample_app.dyn', BytesIO(input_file.getvalue_binary()))]
    ...
    def geometry_and_data_view(self, params, **kwargs):
        ...
        data_output = self.run_dynamo(params)

        # Gather and organize output files from Dynamo
        dynamo_output_for_dataitem = {
