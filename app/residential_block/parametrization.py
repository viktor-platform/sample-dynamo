...
class ResidentialBlockParametrization(Parametrization):
    ...
    step_1.angle = NumberField("Rotation", min=0.0, max=360.0, variant='slider', step=1.0, default=0, suffix='º')
    step_1.depth = NumberField("Depth", max=10.0, min=5.0, variant='slider', step=1.0, default=8.0, suffix='m')
    step_1.width = NumberField("Width", max=6.0, min=4.0, variant='slider', step=1.0, default=5.0, suffix='m')
    ...
    step_2.height_floor = NumberField("Height floor", max=3.0, min=2.0, variant='slider', step=0.1, default=2.5, suffix='m')
    step_2.height_roof = NumberField("Height roof", max=3.0, min=2.0, variant='slider', step=0.1, default=2.5, suffix='m')
