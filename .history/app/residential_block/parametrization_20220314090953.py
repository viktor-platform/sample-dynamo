...
class ResidentialBlockParametrization(Parametrization):
    ...
    Each time the parameters are updated, press the update button the refresh the results.""")
    ...
    \n On the right-hand side some additional output is generated, based on the selected parameters and the dynamo model.""")


    step_3 = Step("Report")
    step_3.text1 = Text("""Create a report of the results of the dynamo model""")
