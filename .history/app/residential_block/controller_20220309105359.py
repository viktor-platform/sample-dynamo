...
class ResidentialBlockController(ViktorController):
	...
	def get_map_view(self, params: Munch, **kwargs) -> MapResult:
		...
		if params.tab1.section2.line:
			...
			transformed_x_wgs, transformed_y_wgs = RDWGSConverter.from_rd_to_wgs((Top_Right_x, Top_Right_y))
			print(transformed_x_wgs, 'en ', transformed_y_wgs)
			features.append(MapPoint(center_x, center_y))
