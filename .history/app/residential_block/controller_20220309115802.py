...
class ResidentialBlockController(ViktorController):
	...
	def get_map_view(self, params: Munch, **kwargs) -> MapResult:
		...
		if params.tab1.section2.point:
			...
			print(center_point.rd[0])
			print(center_point.rd[1])

			center_x = center_point.rd[0]
			center_y = center_point.rd[1]
			angle        = params.tab1.section2.angle*pi/180
			height       = params.tab1.section1.width*params.tab1.section1.number_of_houses
			width        = params.tab1.section1.depth      
			...
			#TOP RIGHT VERTEX:
			Top_Right_x = center_x + ((width / 1) * cos(angle)) - ((height / 1) * sin(angle))
			Top_Right_y = center_y + ((width / 1) * sin(angle)) + ((height / 1) * cos(angle))
			...
			#TOP LEFT VERTEX:
			Top_Left_x = center_x - ((width / 1) * cos(angle)) - ((height / 1) * sin(angle))
			Top_Left_y = center_y - ((width / 1) * sin(angle)) + ((height / 1) * cos(angle))
			...
			#BOTTOM LEFT VERTEX:
			Bot_Left_x = center_x - ((width / 1) * cos(angle)) + ((height / 1) * sin(angle))
			Bot_Left_y = center_y - ((width / 1) * sin(angle)) - ((height / 1) * cos(angle))
			...
			#BOTTOM RIGHT VERTEX:
			Bot_Right_x = center_x + ((width / 1) * cos(angle)) + ((height / 1) * sin(angle))
			Bot_Right_y = center_y + ((width / 1) * sin(angle)) - ((height / 1) * cos(angle))
