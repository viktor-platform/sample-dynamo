...
from viktor.views import Summary, DataGroup, GeometryAndDataView, GeometryAndDataResult
...
class ResidentialBlockController(ViktorController):
	...
	def _map_params_to_dynamo_inputs(params):
		...
		return {
			"Number of houses": params.step_2.section1.number_of_houses,
			"Number of floors": params.step_2.section1.number_of_floors,
			"Depth": params.step_2.section1.depth,
			"Width": params.step_2.section1.width,
			"Height floor": params.step_2.section1.height_floor,
			"Height roof": params.step_2.section1.height_roof,
		}
	...
	def get_map_view(self, params: Munch, **kwargs) -> MapResult:
		...
		if params.step_1.section2.point:
			center_point = params.step_2.section2.point
			center_x, center_y = center_point.rd[0], center_point.rd[1]
			angle        = params.step_2.section2.angle*pi/180
			height       = params.step_2.section1.depth
			width        = params.step_2.section1.width     
			n_houses = params.step_2.section1.number_of_houses 
