...
from viktor.views import Summary, DataGroup, GeometryAndDataView, GeometryAndDataResult, DataView, PDFView, PDFResult
...
class ResidentialBlockController(ViktorController):
    ...
    def get_pdf_view(self, params):
        word_doc = self.render_word_report(params)
        pdf_file = self.convert_word_to_pdf(word_doc)
        return PDFResult(pdf_file)
