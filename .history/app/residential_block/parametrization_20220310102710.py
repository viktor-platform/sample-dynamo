...
class ResidentialBlockParametrization(Parametrization):
	...
	step_1.section2.point = GeoPointField("Draw a point")
	step_1.section2.angle = NumberField("Angle (degrees)", min=0.0, max=360.0, variant='slider', step=1.0, default=0)

	step_2 = Step("Model parameters")

	step_2.section1 = Section("Input building")
